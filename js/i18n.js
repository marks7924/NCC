...
const i18n = (() => {
  ...
  const translations = {
    en: {
      ...
      weatherPermDenied: 'Location permission denied. Search for your city or enter temperature manually below.',
    ...
    ar: {
      ...
      weatherChangeCity: '📍 تغيير المدينة',
      weatherJustNow: 'الآن',
      ...
      weatherPermDenied: 'تم رفض إذن الموقع. ابحث عن مدينتك أو أدخل درجة الحرارة يدويًا أدناه.',
